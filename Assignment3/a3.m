...
function ret = loss(model, data, wd_coefficient)  %loss_function_here
...
%error gradient = ???
  ret.input_to_hid = model.input_to_hid * 0;  %input to hid * error gradient
  ret.hid_to_class = model.hid_to_class * 0;  %input to hid * error gradient
end
