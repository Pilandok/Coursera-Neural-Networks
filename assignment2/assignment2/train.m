...
hid_bias = zeros(numhid2, 1); %bias of hidden units
...
%*NTS chose option a    embed_to_hid_weights_gradient = zeros(numhid1 * numwords, numhid2);
    ...
    % (c) embed_to_hid_weights_gradient = back_propagated_deriv_1; *NTS probably not this
    % (d) embed_to_hid_weights_gradient = embedding_layer_state; *NTS definitely not this 
...
%    hid_bias_gradient = zeros(numhid2, 1);
    ...
    % (b) hid_bias_gradient = sum(back_propagated_deriv_1, 1); *NTS selected this
